...
class stm32_to_rk3588_uart {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new stm32_to_rk3588_uart(null);
  ...
  static datatype() {
    ...
    return 'stm32_to_rk3588/stm32_to_rk3588_uart';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new stm32_to_rk3588_uart(null);
...
module.exports = stm32_to_rk3588_uart;
